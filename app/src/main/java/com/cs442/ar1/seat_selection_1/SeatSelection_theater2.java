...
/**
 * Created by ar1 on 11/11/2016.
 */
public class SeatSelection_theater2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seat_selection_theater2);
...
//                    toast.show();
        ...
        B5.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(colorid==(-1654272)) {
                    B5.setBackgroundColor(Color.parseColor("#87A96B"));
                    seats_counter++;
                    arrayList.add("B5");
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have selected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    ...
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have unselected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    B5.setBackgroundColor(Color.parseColor("#E6C200"));
                    seats_counter--;
                    arrayList.remove("B5");
                }
            }
        ...
        B6.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(colorid==(-1654272)) {
                    B6.setBackgroundColor(Color.parseColor("#87A96B"));
                    seats_counter++;
                    arrayList.add("B6");
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have selected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    ...
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have unselected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    B6.setBackgroundColor(Color.parseColor("#E6C200"));
                    seats_counter--;
                    arrayList.remove("B6");
                }
            }
        ...
        C5.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                ColorDrawable buttonColor = (ColorDrawable) C5.getBackground();
                colorid= buttonColor.getColor();

                if(colorid==(-1654272)) {
                    C5.setBackgroundColor(Color.parseColor("#87A96B"));
                    seats_counter++;
                    arrayList.add("C5");
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have selected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    ...
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have unselected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    C5.setBackgroundColor(Color.parseColor("#E6C200"));
                    seats_counter--;
                    arrayList.remove("C5");
                }
            }
        ...
        C6.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                ColorDrawable buttonColor = (ColorDrawable) C6.getBackground();
                colorid= buttonColor.getColor();

                if(colorid==(-1654272)) {
                    C6.setBackgroundColor(Color.parseColor("#87A96B"));
                    seats_counter++;
                    arrayList.add("C6");
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have selected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    ...
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have unselected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    C6.setBackgroundColor(Color.parseColor("#E6C200"));
                    seats_counter--;
                    arrayList.remove("C6");
                }
            }
        ...
        D5.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                ColorDrawable buttonColor = (ColorDrawable) D5.getBackground();
                colorid= buttonColor.getColor();

                if(colorid==(-1654272)) {
                    D5.setBackgroundColor(Color.parseColor("#87A96B"));
                    seats_counter++;
                    arrayList.add("D5");
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have selected this seat.",Toast.LENGTH_SHORT);
                    //toast.show();
                    ...
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have unselected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    D5.setBackgroundColor(Color.parseColor("#E6C200"));
                    seats_counter--;
                    arrayList.remove("D5");
                }
            }
        ...
        D6.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                ColorDrawable buttonColor = (ColorDrawable) D6.getBackground();
                colorid= buttonColor.getColor();

                if(colorid==(-1654272)) {
                    D6.setBackgroundColor(Color.parseColor("#87A96B"));
                    seats_counter++;
                    arrayList.add("D6");
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have selected this seat.",Toast.LENGTH_SHORT);
                    //toast.show();
                    ...
                    //Toast toast= Toast.makeText(getApplicationContext(),"You have unselected this seat.",Toast.LENGTH_LONG);
                    //toast.show();
                    D6.setBackgroundColor(Color.parseColor("#E6C200"));
                    seats_counter--;
                    arrayList.remove("D6");
                }
            }
    ...
    public void seat_information(View V){
        ...
        //    System.out.println("The date is: "+ date);
            ...
            intent = new Intent(SeatSelection_theater2.this,Confirmation.class);
